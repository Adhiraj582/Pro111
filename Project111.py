...
first_std_start, first_std_end = sampling_mean - standard_dev, sampling_mean+standard_dev
second_std_start, second_std_end = sampling_mean - (2*standard_dev), sampling_mean+(2*standard_dev)
third_std_start, third_std_end = sampling_mean - (3*standard_dev), sampling_mean+(3*standard_dev)
